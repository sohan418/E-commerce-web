 ...
 <div class="icons">
   ...
   <a href="login.php">logout</a>
    ...
    <div class="small-container single-prodect">
        <div class="row">
            <div class="col-2">
                <img src="images/kettle.jpg" alt="" width=" 400px" height="400px" id="ProductImg"  >

                            <div class="small-img-row">
                                <div class="small-img-col">
                                    <img src="images/kettle-1.jpg" alt="" width="100%" class="small-img">
                                </div>
                                <div class="small-img-col">
                                    <img src="images/kettle-2.jpg" alt="" width="100%" class="small-img">
                                </div>
                                <div class="small-img-col">
                                    <img src="images/kettle-3.jpg" alt="" width="100%" class="small-img">
                                </div>
                                <div class="small-img-col">
                                    <img src="images/kettle-4.jpg" alt="" width="100%" class="small-img">
                                </div>
                            </div>
            </div>
                <div class="col-2">
                ...
                <h3> MILTON GO Electro 2000 Electric Kettle  (2 L, Silver)</h3>
                <h3>₹1,279</h3> <h3> <small class="line">₹1,465 </small><bdi>12% off</bdi></h3>
                ...
                <p class="detail">  General
                    <li>
                        <ol>
                            Model Name- Go Electro 2000
                    Series
                    Go Electro
                    Power Indicator
                    Yes
                    ...
                    Yes
                    Sales Package
                    1 - Piece GO Electro Electric Kettle (2 Litres)
                    Dimensions
                    Cord Length
                    0.75 m
                        </ol>
