 ...
 <div class="icons">
   ...
   <a href="login.php">logout</a>
    ...
    <div class="small-container single-prodect">
        <div class="row">
            <div class="col-2">
                <img src="images/charger.jpg" alt=""  width=" 400px" height="400px" id="ProductImg"  >

                            <div class="small-img-row">
                                <div class="small-img-col">
                                    <img src="images/charger-1.jpg" alt="" width="100%" class="small-img">
                                </div>
                                <div class="small-img-col">
                                    <img src="images/charger-2.jpg" alt="" width="100%" class="small-img">
                                </div>
                                <div class="small-img-col">
                                    <img src="images/charger-3.jpg" alt="" width="100%" class="small-img">
                                </div>
                                <div class="small-img-col">
                                    <img src="images/charger-4.jpg" alt="" width="100%" class="small-img">
                                </div>
                            </div>
            </div>
                <div class="col-2">
                ...
                <h3>Prifakt 10 W 2.4 A Mobile High Speed Mobile Wall Charger for O_ppo F9 F9 Pro F7 F5 F3 F3 Plus A71 A71K A83 Charger with Detachable Cable  (White, Cable Included) </h3>
                <h3> ₹369</h3> <h3> <small class="line"> ₹1,299 </small><bdi>71% off</bdi></h3>
                 <h4 class="star">3.8<i class="fa fa-star unchecked"></i>
                     </h4>
                 
                <a href="Advance_Shopping_cart-master/index.php" class="btn"> Add to card</a>
                <h3>  <i class="fa fa-indent"></i></h3><br>
                <p class="detail">Sales Package<br>
                    1 ADAPTER, 1 CABLE
                    Model Number-
                    High Speed Mobile Wall Charger for O_ppo F9 F9 Pro F7 F5 F3 F3 Plus A71 A71K A83<br>
                    Model Name-
                    Oppo Charger<br>
                    Output Interface-
                    USB Type A<br>
