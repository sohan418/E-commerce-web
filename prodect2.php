...
<body>
    ...
    <div class="small-container single-prodect">
        <div class="row">
            <div class="col-2">
                <img src="images/headphone.jpg" alt=""  width=" 400px" height="400px" id="ProductImg"  >

                            <div class="small-img-row">
                                <div class="small-img-col">
                                    <img src="images/headphone-1.jpg" alt="" width="100%" class="small-img">
                                </div>
                                <div class="small-img-col">
                                    <img src="images/headphone-2.jpg" alt="" width="100%" class="small-img">
                                </div>
                                <div class="small-img-col">
                                    <img src="images/headphone-3.jpg" alt="" width="100%" class="small-img">
                                </div>
                                <div class="small-img-col">
                                    <img src="images/headphone-4.jpg" alt="" width="100%" class="small-img">
                                </div>
                            </div>
            </div>
                <div class="col-2">

                <p><a href="index.html" class="home"><h2>home</h2></a> <h3>/ headphone</h3></p>
                <h3> truke Buds Q1 with Quad Mic ENC, 6-8 Hours Playtime, 10mm drivers with AAC codec Bluetooth Headset  (Black, True Wireless) </h3>
                <h3> ₹1,099</h3> <h3> <small class="line">₹3,499 </small><bdi>68% off</bdi></h3>
                ...
                <h3>prodect details <i class="fa fa-indent"></i></h3><br>
                <p class="detail"> With Mic:Yes <br>
                    <li>
                    Bluetooth version: 5.1 
                    Wireless range: 10 m 
                    Battery life: 30 hours | Charging time: 1.5 hrs 
                    Playtime: 6-8 hours
                </li>
            </div>
