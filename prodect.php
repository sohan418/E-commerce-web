...
<body>
    ...
    <div class="small-container single-prodect">
        <div class="row">
            <div class="col-2">
                <img src="images/realme.jpg" alt=""  id="ProductImg" height="400px" width="400px" >

                            <div class="small-img-row">
                                <div class="small-img-col">
                                    <img src="images/realme-1.jpg" alt="" width="100%" class="small-img">
                                </div>
                                <div class="small-img-col">
                                    <img src="images/realme-2.jpg" alt="" width="100%" class="small-img">
                                </div>
                                <div class="small-img-col">
                                    <img src="images/realme-3.jpg" alt="" width="100%" class="small-img">
                                </div>
                                <div class="small-img-col">
                                    <img src="images/realme-4.jpg" alt="" width="100%" class="small-img">
                                </div>
                            </div>
            </div>
                <div class="col-2">

                <p><a href="index.html" class="home"><h2>home</h2></a> <h3>/realme C33</h3></p>
                <h3> realme C33 (Night Sea, 32 GB)  (3 GB RAM)</h3>
                <h3> ₹8,999</h3> <h3> <small class="line"> 11,999 </small><bdi>25% off</bdi></h3>
                 <h4 class="star">4.5<i class="fa fa-star unchecked"></i>
                ...
                <p class="detail"> 3 GB RAM | 32 GB ROM |<br> Expandable Upto 1 TB
                    16.51 cm (6.5 inch) HD+ Display <br>
                    50MP + 0.3MP | 5MP Front Camera <br>
                    5000 mAh Lithium Ion Battery <br>
                    Unisoc T612 Processor</p>
            </div>
