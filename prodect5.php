 ...
 <div class="icons">
   ...
   <a href="login.php">logout</a>
    ...
    <div class="small-container single-prodect">
        <div class="row">
            <div class="col-2">
                <img src="images/camera.jpg" alt=""  width="100%" height="300px" id="ProductImg"  >

                            <div class="small-img-row">
                                <div class="small-img-col">
                                    <img src="images/camera-1.jpg" alt="" width="100%" class="small-img">
                                </div>
                                <div class="small-img-col">
                                    <img src="images/camera-2.jpg" alt="" width="100%" class="small-img">
                                </div>
                                <div class="small-img-col">
                                    <img src="images/camera-3.jpg" alt="" width="100%" class="small-img">
                                </div>
                                <div class="small-img-col">
                                    <img src="images/camera-4.jpg" alt="" width="100%" class="small-img">
                                </div>
                            </div>
            </div>
                <div class="col-2">
                ...
                <h3> SONY ZV-E10L Mirrorless Camera Body with 1650 mm Power Zoom Lens Vlog Camera  (Black) </h3>
                <h3>₹61,490</h3> <h3> <small class="line">₹69,990</small><bdi>12% off</bdi></h3>
